import {AnyString, DateTime, EnumString, Money, NonEmptyString} from "../../Common/Model/TypeValidators";
...
export class Address {
    ...
    constructor(street: Street, city: City, state: State, zipCode: ZipCode, country: Country) {
        this.street = street;
        this.city = city;
        this.state = state;
