import { RecurringSubscriptionAgreementTemplateVersions, Template } from './types';

export const latestRecurringSubscriptionAgreementVersion: RecurringSubscriptionAgreementTemplateVersions = 1;

export const recurringSubscriptionAgreementsTemplates: Record<RecurringSubscriptionAgreementTemplateVersions, Template> = {
  1: [
    {
      paragraphs: [
        {
