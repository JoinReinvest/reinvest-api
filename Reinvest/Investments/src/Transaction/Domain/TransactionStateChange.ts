...
export class TransactionStateChange {
  ...
  public static tradeAwaiting(
    transactionId: TransactionId
  ): TransactionStateChange {
    const state = new TransactionStateChange(
      transactionId,
      TransactionState.TradeAwaiting
    );
  ...
  public static retryTradeAwaiting(
    transactionId: TransactionId,
    tradeCreationCounter: Counter
  ): TransactionStateChange {
    const state = new TransactionStateChange(
      transactionId,
      TransactionState.Same
    );
  ...
  static signingSubscriptionAgreementAwaiting(
    transactionId: TransactionId,
    unitPrice: UnitPrice,
    numberOfShares: NumberOfShares
  ) {
  ...
  public static retrySigningSubscriptionAgreementAwaiting(
    transactionId: TransactionId,
    ...
    state._metadata.lastActionRetryCounter =
      signingSubscriptionAgreementCounter;

    return state;
  }

  public static fundsTransferAwaiting(
    transactionId: TransactionId
  ): TransactionStateChange {
    const state = new TransactionStateChange(
      transactionId,
  ...
  public static retryFundsTransferAwaiting(
    transactionId: TransactionId,
    fundsTransferInitializationCounter: Counter
  ): TransactionStateChange {
    const state = new TransactionStateChange(
      transactionId,
      TransactionState.Same
  ...
  public static paymentAwaiting(
    transactionId: TransactionId
  ): TransactionStateChange {
    const state = new TransactionStateChange(
      transactionId,
      TransactionState.PaymentAwaiting
    );
    state._metadata.lastActionRetryCounter = Counter.init();
  ...
  public static verificationAwaiting(
    transactionId: TransactionId
  ): TransactionStateChange {
    return new TransactionStateChange(
      transactionId,
      TransactionState.VerificationAwaiting
    );
  }

  public static sharesIssuanceAwaiting(
    transactionId: TransactionId
  ): TransactionStateChange {
    return new TransactionStateChange(
      transactionId,
      TransactionState.SharesIssuanceAwaiting
    );
  }

  static waitingForManualAction(
    transactionId: TransactionId,
    reason: ManualActionReason
  ) {
    const state = new TransactionStateChange(
      transactionId,
      TransactionState.ManualActionAwaiting
    );
  ...
  static waitingForAdminManualAction(
    transactionId: TransactionId,
    reason: ManualActionReason
  ) {
    const state = new TransactionStateChange(
  ...
  static completeWithSuccess(transactionId: TransactionId, sharesId: SharesId) {
    const state = new TransactionStateChange(
      transactionId,
      TransactionState.CompletedWithSuccess
    );
  ...
  static retryTradeUnwindAwaiting(
    transactionId: TransactionId,
  ...
  public static changeBackToState(
    transactionId: TransactionId,
