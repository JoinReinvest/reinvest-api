...
export class TradeAwaitingTransaction
  ...
  implements Transaction
{
  ...
  private retryCreateTrade(event: TransactionCreated): TransactionDecision {
    if (
      this.tradeCreationCounter.isHigherEqualThan(
    ...
    return new TransactionDecision(
      ...
      TransactionStateChange.retryTradeAwaiting(
        this.transactionId,
        this.tradeCreationCounter.increment()
      )
    );
  }
