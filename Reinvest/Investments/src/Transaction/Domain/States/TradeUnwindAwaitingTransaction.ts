...
export class TradeUnwindAwaitingTransaction
  ...
  implements Transaction
{
  ...
  private retryUnwindTrade(): TransactionDecision {
    if (
      this.tradeUnwindCounter.isHigherEqualThan(
    ...
    return new TransactionDecision(
      ...
      TransactionStateChange.retryTradeUnwindAwaiting(
        this.transactionId,
        this.tradeUnwindCounter.increment()
      )
    );
  }
}
