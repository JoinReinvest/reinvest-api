...
import { SharesIssuanceAwaitingTransaction } from "../../../../../src/Transaction/Domain/States/SharesIssuanceAwaitingTransaction";
...
context(
  "Given the trade was disbursed and awaiting for shares issuance",
  () => {
    ...
    describe("When the system issues shares", () => {
      ...
      it("Then the transaction should be successful", async () => {
        const decision: TransactionDecision =
          transaction.execute(sharesWereIssued);
    ...
    describe("When the shares issuance fails", () => {
      ...
      it("Then the system should wait for the admin manual action", async () => {
        const decision: TransactionDecision =
          transaction.execute(sharesIssuanceFailed);
