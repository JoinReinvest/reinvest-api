...
import { DisbursementAwaitingTransaction } from "../../../../../src/Transaction/Domain/States/DisbursementAwaitingTransaction";
...
context(
  "Given the verification success and grace period ended and awaiting for trade disbursement",
  () => {
    ...
    describe("When the trade was disbursed", () => {
      ...
      it("Then the transaction should issue shares to the investor", async () => {
        const decision: TransactionDecision =
          transaction.execute(tradeDisbursed);
