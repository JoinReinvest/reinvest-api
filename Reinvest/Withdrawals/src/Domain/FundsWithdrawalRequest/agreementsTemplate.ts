import { FundsWithdrawalAgreementTemplateVersions, Template } from './types';

export const latestAgreementVersion: FundsWithdrawalAgreementTemplateVersions = 1;
export const fundsWithdrawalAgreementTemplate: Record<FundsWithdrawalAgreementTemplateVersions, Template> = {
  1: [
    {
      paragraphs: [
        {
