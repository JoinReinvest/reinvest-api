...
import {
  createInvestmentAccountsDatabaseAdapterProvider,
  InvestmentAccountDbProvider,
  InvestmentAccountsDatabase,
...
export default class AdaptersProviders {
  ...
  public boot(container: ContainerInterface) {
    ...
    container
      ...
      .addObjectFactory(
        'InvestmentAccountsTransactionalAdapter',
        (databaseProvider: InvestmentAccountDbProvider) => new TransactionalAdapter<InvestmentAccountsDatabase>(databaseProvider),
        [investmentAccountsDatabaseProviderName],
      )
      .addObjectFactory(
